        ...
        switch (requestCode) {
            case 200: {
                ...
                if (grantResults.length > 0
                    ...
                    Log.i("permission was granted.","yes");

                } else {
                    // permission denied.
                    // tell the user the action is cancelled
                    AlertDialog alertDialog = new AlertDialog.Builder(getActivity()).create();
                    alertDialog.setMessage("s'il voux plait donnez permission d'appel");
            ...
            case 123:
            {
                if (grantResults.length > 0
                    ...
                    // tell the user the action is cancelled
                    AlertDialog alertDialog = new AlertDialog.Builder(getActivity()).create();
                    alertDialog.setMessage("s'il voux plait donnez permission d'envoyer un message");
                    alertDialog.setButton(AlertDialog.BUTTON_NEUTRAL, "ok",
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    dialog.dismiss();
